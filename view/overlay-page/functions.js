function showPaymentOverlay() {
  ...
  $('select.payment-currency-selector').change(function () {
    ...
    if (votingState['currencyTicker'] in exchangeRate) {
      ...
      $('.payment-token-count')
        .empty()
        .append(parseInt($('.payment-vote-count').text()) * theRate)
    }
  })
}
...
function resetPhotoOverlay() {
  ...
  $('.photo-vote-img').attr(
    'src',
    'https://uploads-ssl.webflow.com/6279c7595e56e5a596e3bafb/641d3b66f0752c6b5261f79f_18586-editing-magic.gif'
  )
  //Reset counter
